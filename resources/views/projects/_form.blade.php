...
<div>
    ...
    <textarea name="description" id="description" rows="4"
        class="bg-white rounded-md focus:outline-none focus:ring-2 focus:ring-sky-950 w-full p-2 mb-2"
        required>{{ old('description', $project) }}</textarea>
</div>
...
<div class="w-full my-4">
    <img class="w-full " src="{{ asset('storage/' . $project->image) }}" alt="{{ $project->title }}" class="max-w-xs rounded-lg shadow-md">
</div>
@endif
